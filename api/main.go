...
func main() {
	...
	client := client.NewDatastoreClient(config.DatastoreIp, config.DatastorePort)
	echoServer := echo.New()
...
func getNewPersonHandler(client *client.DatastoreClient) func(ctx echo.Context) error {
...
func getGetPersonHandler(client *client.DatastoreClient) func(ctx echo.Context) error {
	return func(c echo.Context) error {
		idStr := c.Param(personIdParam)
		key, err := getPersonKeyFromIdString(idStr)
		if err != nil {
...
func getIncrementBooksReadHandler(client *client.DatastoreClient) func(ctx echo.Context) error {
	return func(c echo.Context) error {
		idStr := c.Param(personIdParam)
		key, err := getPersonKeyFromIdString(idStr)
		if err != nil {
